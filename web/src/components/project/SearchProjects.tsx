...
const SearchProjects = ({ deleteId, deleteProject, setDeleteProjectPanel, setDeleteId, activatePlaybar, contributorsPanel,toggleContributors, intialiseProject, searchInput }:Props) => {
