...
import { DELETE_TAB , DELETE_LYRIC} from "../../graphql/mutations";
import { GET_TABS, GET_LYRICS } from "../../graphql/queries";
// Redux 
...
const DeleteWSItem = ({wsType, itemId, initTabDeletion, initLyricDeletion}: Props) => {
